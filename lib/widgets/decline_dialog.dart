...
class DeclineSessionDialog extends StatefulWidget {
  ...
  _DeclineSessionDialogState createState() => _DeclineSessionDialogState();
}

class _DeclineSessionDialogState extends State<DeclineSessionDialog> {

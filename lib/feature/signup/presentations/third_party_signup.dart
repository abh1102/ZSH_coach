...
class ThirdPartySignUpSecondScreen extends StatefulWidget {
  final String email;
  const ThirdPartySignUpSecondScreen({super.key, required this.email});

  @override
  State<ThirdPartySignUpSecondScreen> createState() =>
      _ThirdPartySignUpSecondScreenState();
}

class _ThirdPartySignUpSecondScreenState
    extends State<ThirdPartySignUpSecondScreen> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ColoredButton(
                            ...
                            onpressed: () async {
                              if (isValidName(provider.fullNameControllerP.text
                                          .trim()) ==
                                      true &&
                                  containsEmoji(provider
                                          .fullNameControllerP.text
                                          .trim()) ==
                                      false &&
                                  provider.stateControllerP.text
                                      .trim()
                                      .isNotEmpty &&
                                  provider.countryControllerP.text
                                      .trim()
                                      .isNotEmpty &&
                                  provider.phoneNumberControllerP.text
                                      .trim()
                                      .isNotEmpty &&
                                  provider.countryCodeControllerP.text
                                      .trim()
                                      .isNotEmpty &&
                                  provider.fullNameControllerP.text
                                      .trim()
                                      .isNotEmpty &&
                                ...
                                if (containsEmoji(provider
                                        .fullNameControllerP.text
                                        .trim()) ==
                                    true) {
                                  showSnackBar(
                                      "Do not use emoji in name and password text field");
                                } else {
                                  showSnackBar(

...
class LocalVideoPlayingScreen extends StatefulWidget {
  final File video;
  const LocalVideoPlayingScreen({super.key, required this.video});

  @override
  State<LocalVideoPlayingScreen> createState() =>
      _LocalVideoPlayingScreenState();
}

class _LocalVideoPlayingScreenState extends State<LocalVideoPlayingScreen> {
